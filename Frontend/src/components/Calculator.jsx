...
const Calculator = () => {
    ...
    const handleClick=(e)=>{
        ...
        else if(inputValue.toString().charAt(0)==="0" || (inputValue.toString().charAt(0)==="/" || inputValue.toString().charAt(0)==="*" || inputValue.toString().charAt(0)==="+" || inputValue.toString().charAt(0)===".")){
            setInputValue(e.target.value);
        }
